 ...
 */
	public function delete($id = null) {
		...
		if ($this->Category->delete()) {
			$this->Session->setFlash(__('Category was successfully deleted!', array('class' => 'success_message')));
			$this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__('Category was not deleted', array('class' => 'error_message')));
		$this->redirect(array('action' => 'index'));
	}
}

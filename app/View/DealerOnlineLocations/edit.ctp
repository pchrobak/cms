...
<div class="page-content">
	...
	<fieldset>
		...
		<?php echo $this->Form->create('DealerOnlineLocation'); ?>
	<?php
		...
		echo $this->Form->input('website', array('class' => 'input-xxlarge'));?>
				<div class="input text">
					...
					<input id="xFilePath" name="data[DealerOnlineLocation][logo]" value="<?php echo $this->data["DealerOnlineLocation"]["logo"]?>" type="text" class="input-xlarge">

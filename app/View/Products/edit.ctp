...
<div class="page-content">
	...
	<fieldset>
		<legend><?php echo __('Edit Products'); ?>
			<div class="btn-group pull-right">
				...
				<ul class="dropdown-menu">
					<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Products.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Products.id'))); ?></li>
...
<?php echo $this->Form->create('Product'); ?>
	<?php
		...
		echo $this->Form->input('visible', array('class' => 'input-xxlarge'));

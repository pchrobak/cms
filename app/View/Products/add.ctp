...
<?php echo $this->Form->create('Product'); ?>
	<fieldset>
		<legend><?php echo __('Add a Product'); ?> <button class="btn pull-right"><?php echo $this->Html->link(__('List Products'), array('action' => 'index')); ?></button></legend>
	<?php
		echo $this->Form->input('visible');
		echo $this->Form->input('name', array('class' => 'input-xxlarge'));
		echo $this->Form->input('series_id', array('class' => 'input-xxlarge'));
